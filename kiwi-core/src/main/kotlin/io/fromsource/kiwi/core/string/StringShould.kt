...
class StringShould(private val actual: String) : io.fromsource.kiwi.core.BeEqual<String, StringShould>, io.fromsource.kiwi.core.BeComparable<String, StringShould> {
